...
@pytest.mark.parametrize(
    "with_icu, target_type, nb_days, disease_readmission, disease_selection, expected_admission_records_count, expected_patients_count, expected_positive_cases_count",
    [
...
def test_cohort_extractor(
    ...
    prediction_task = PredictionTask(
        target_type, disease_readmission, disease_selection, nb_days, with_icu
    )
